...
public class JobDetail {
    ...
    public int getScrapeJobId() { return scrapeJobId; }
    public void setScrapeJobId(int scrapeJobId) { this.scrapeJobId = scrapeJobId; }
    ...
    public void setJobInfo(String jobInfo) { this.jobInfo = jobInfo; }
