...
public class EditJobServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            skills = gson.fromJson(jobDetail.getSkills(), new TypeToken<List<String>>(){}.getType());
        } catch (Exception e) {
            skills = List.of();
        }
        ...
        try {
            descriptions = gson.fromJson(jobDetail.getDescriptions(), new TypeToken<Map<String, String>>(){}.getType());
        } catch (Exception e) {
            descriptions = Map.of();
        }
        ...
        try {
            jobInfo = gson.fromJson(jobDetail.getJobInfo(), new TypeToken<Map<String, String>>(){}.getType());
        } catch (Exception e) {
            jobInfo = Map.of();
        }
