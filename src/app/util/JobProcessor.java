...
public class JobProcessor {
    ...
    private void processTask(ScrapeTask task) {
        ...
        try {
            ...
            java.util.Map<String, Object> runningState = new java.util.HashMap<>();
            ...
            app.util.ProgressBroadcaster.getInstance().publish(job.getId(), new com.google.gson.Gson().toJson(runningState));
            ...
            List<JobDetail> results = scrapeManager.scrapeUrls(urls, detail -> {
                ...
                java.util.Map<String, Object> updateState = new java.util.HashMap<>();
                ...
                app.util.ProgressBroadcaster.getInstance().publish(job.getId(), new com.google.gson.Gson().toJson(updateState));
            });
            if (results.isEmpty()) {
            ...
            // publish completion
            java.util.Map<String, Object> completedState = new java.util.HashMap<>();
            ...
            app.util.ProgressBroadcaster.getInstance().publish(job.getId(), new com.google.gson.Gson().toJson(completedState));
            System.out.println("[JobProcessor] Job ID " + job.getId() + " completed successfully with " + results.size() + " results");
        } catch (Exception e) {
            ...
            java.util.Map<String, Object> failedState = new java.util.HashMap<>();
            ...
            app.util.ProgressBroadcaster.getInstance().publish(job.getId(), new com.google.gson.Gson().toJson(failedState));
